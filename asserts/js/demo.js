...
(function(win) {
	var demo = {
		...
		createAllItems: function() {
			var demoContent = [{
				demoLink: 'https://github.com/jchanghong',
				imgLink: 'https://jchanghong.github.io/staticResource/blog/hybrid/img_hybrid_base_hybridInfo_1.jpg',
				codeLink: 'https://github.com/jchanghong',
				title: 'Hybrid示例应用',
				relevant: 'js Hybrid模式',
				description: '混合开发，原生容器，h5+js进行业务功能开发，提升开发效率'
			}, {
				demoLink: 'https://github.com/jchanghong',
				imgLink: 'https://jchanghong.github.io/staticResource/blog/hybrid/img_hybrid_base_hybridInfo_2.jpg',
				codeLink: 'https://github.com/jchanghong',
				title: 'Hybrid示例应用',
				relevant: 'js Hybrid模式',
				description: '混合开发，原生容器，h5+js进行业务功能开发，提升开发效率'
				...
				demoLink: 'https://github.com/jchanghong',
				imgLink: 'https://jchanghong.github.io/staticResource/blog/hybrid/img_hybrid_base_hybridInfo_3.jpg',
				codeLink: 'https://github.com/jchanghong',
				title: 'Hybrid示例应用',
				relevant: 'js Hybrid模式',
				description: '混合开发，原生容器，h5+js进行业务功能开发，提升开发效率'
